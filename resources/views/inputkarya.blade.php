        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Input Karya</h1>
...
<section class="container-i">
    <form action="http://192.168.1.4:8000/api/create" method="post" enctype="multipart/form-data" class="form">
        ...
        <div class="input-box">
            <label for="categori_id">Category ID</label>
            <input type="text" id="categori_id" name="categori_id" placeholder="Enter Category ID" required="required" onChange="return validateInput(value,'categori_id')" />
        </div>
        <div class="input-box">
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $response = $client->post('http://192.168.1.9:8000/api/create', [
            'multipart' => [
                [
            'name' => 'title',
        ...
        if ($response->getStatusCode()==200){
            header('Location: http://127.0.0.1:8000/KaryaSiswa?success=true');
            exit;
        }
    }
?>
...
<div class="row g-4 justify-content-center" >
    <div class="text-center position-relative overflow-hidden">  
      <a href="/KaryaSiswa"class="btn my-button align-self-start px-3"   class="btn btn-red btn-detail" style="border-radius: 30px 30px 30px 30px;"><- KaryaSiswa</a>                
