    ...
    <div class="container">
      <div class="row g-5">
        <div class="col-md-7 order-md-2">
            <blockquote><h2 class="featurette-heading-left fw-normal lh-1 ">DKV</h2><blockquote>
          <p class="lead-left" align="justify">DKV adalah cabang ilmu desain. Di jurusan ini, siswa belajar konsep komunikasi dan ungkapan kreatif dengan menggunakan berbagai elemen visual untuk menyampaikan pesan. Dengan gambar visual,siswa belajar menyampaikan pesan secara informatif, efektif, dan komunikatif.
            <br><br> Mata pelajaran Dasar-Dasar Desain Komunikasi Visual merupakan mata pelajaran kejuruan berisi kompetensi-kompetensi yang mendasari penguasaan keahlian pekerjaan desain komunikasi visual. Di dalamnya berisi berbagai ilmu dasar sebagai bekal mempelajari mata pelajaran lain. Keberadaannya berfungsi membekali peserta......
          </p>
          <a class="btn my-button align-self-start px-3" type="button" data-bs-toggle="modal" data-bs-target="#modal0" >Selengkapnya</a>
          <br><br><br><blockquote><h2 class="featurette-heading-left fw-normal lh-1 ">Tujuan Belajar</h2><blockquote>
          <p class="lead-left" align="justify">membekali peserta didik dengan dasar-dasar pengetahuan, keterampilan, dan sikap (soft skills dan hard skills) meliputi:
            <br>1. memahami profil technopreneur, peluang usaha dan pekerjaan/profesi di bidang Desain Komunikasi Visual;
           <br> 2. memahami proses bisnis berbagai industri di bidang Desain Komunikasi Visual;</p>
          <a class="btn my-button align-self-start px-3" type="button" data-bs-toggle="modal" data-bs-target="#modal" >Selengkapnya</a>
          <br><br><br> <blockquote><h2 class="featurette-heading-left fw-normal lh-1 ">Karakteristik Mata Pelajaran</h2><blockquote>
          <p class="lead-left" align="justify">Pada hakekatnya mata pelajaran Dasar-Dasar Desain Komunikasi Visual berfokus pada kompetensi bersifat dasar yang harus dimiliki oleh seniman, dan/atau pekerja seni dalam bidang desain komunikasi visual sesuai dengan perkembangan dunia kerja......</p>
