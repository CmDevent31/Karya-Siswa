...
<a href="#"class="btn my-button align-self-start px-3"   class="btn btn-red btn-detail" type="submit">Register</a>
</div>
</div>

<div>
    <br>Lupa password akun? <a href="#" class="text-decoration-none">Lupa password</a>
</div>
